...
This will eventually contain the full wiring harness for my EVJ55 EV conversion project.  I hope to use large parts of the original harness for things like lighting, wipers, liftgate glass, etc.  I'll add in a custom relay box (probably from an old HDJ81 wiring harness I already have) as well as HF2A transfer case wiring for 4wd activation and sensors.
...
* The Zombie specific stuff have been moved out to https://github.com/hpeyerl/gs450h_ls600hl_zombie_vcu
